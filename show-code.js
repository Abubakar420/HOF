...
window.addEventListener('load', () => {
    ...
    if (topic == 'living-room') {
        ...
        const namelist = ["", "abubakar", "Luxury Master Bedroom With Metallic Jali", "Modern Master Bedroom With Grey Colour Theme And Large Windows", "Luxury Master Bedroom With Metallic Piece On Wall", "Modern Master Bedroom With Large French Windows", "Modern Master Bedroom With Zigzag Patterned Wallpaper", "Small Master Bedroom With Soft Hues And Modern Furniture", "Modern Master Bedroom With Wooden Ceiling And Wooden Flooring", "Master Bedroom With Brown And Blue Colour Schemes", "Luxury Master Bedroom With Chandelier And Wooden Flooring"];
